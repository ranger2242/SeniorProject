...
//            godMatrix[i][4] = singleClass.getName();
    ...
    public ArrayList<Object[][][]> transformTrainingData(
            ProjectData<ArrayList<Set<ExtractedClass>>, ArrayList<Set<com.ANZR.Ergo.parser.Enum>>> arr){
    ...
    public Object[][][] transformData(
            ProjectData<ArrayList<Set<ExtractedClass>>, ArrayList<Set<com.ANZR.Ergo.parser.Enum>>> projectClassData){
